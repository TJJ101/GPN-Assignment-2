/*
Below is a list of all FontAwesome icons as they are used in Gamemaker.
All icon names from FontAwesome can be found at http://fontawesome.io/cheatsheet/.

When using the FontAwesome icons in gamemaker, simply replace the - in the name, with _ to get the Gamemaker equivalent.
The exception being fa_archive. Coincidentally, there was a gamemaker function called fa_archive, so the FontAwesome fa_archive is listed as fa_archives.
...
fa_angle_up
fa_apple
fa_archives <- Be careful not to use fa_archive. There is a built-in Gamemaker function called fa_archive.
fa_area_chart
